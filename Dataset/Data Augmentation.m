% % Data Augmentaion Notebook
% % The purpose fo this notebook is the augment the ADP training dataset 
% % The augment dataset is the used to train the AE
% % Written by: Katarina
% % Date 9/20/2023
clear all
close all
